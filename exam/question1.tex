...
\begin{exm}[Пример универсальной алгебры]
Пусть 
...
\begin{dfn}[Значение терма на состоянии]
...
\begin{dfn}[Терм, содержащий переменные]
